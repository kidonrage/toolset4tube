...
`scan` streams selected playlist entries from `yt-dlp` and writes live progress to stderr
while each entry is fetched and cached locally. Final counts are printed as scanned,
errors, and skipped.
